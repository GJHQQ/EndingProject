...
<html>
  ...
  <head>
	...
	<style>
	textarea{border:1px solid #ebebeb;width:1000px;resize:none;height:500px;padding:5px;text-indent: 2em;}
  ...
  <!-- 失败提示 -->
    <c:if test="${requestScope.bools == '0'}">
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	  ...
	  <tr>
	    ...
	    <form method="post" action="ArticleServlet?type=submit">
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	      ...
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input type="text" name="ar_number" value="${requestScope.article.max+1}" class="text-word" id="user_pwd" placeholder="" >
	        </td>
	      </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        <td align="right" valign="middle" class="borderright borderbottom bggray">文章标题：</td>
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input type="text" name="ar_title" value="" class="text-word" id="user_pwd" placeholder="" >
	        </td>
	      </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        <td align="right" valign="middle" class="borderright borderbottom bggray">文章内容：</td>
	        <td align="left" valign="middle" class="borderright borderbottom main-for" style="width:1200px;">
	        <textarea name="ar_content" value="" class="text-word" id="editor" placeholder="" style="height:450px;"></textarea>
	      ...
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input type="text" name="ar_user" value="" class="text-word" id="user_pwd" placeholder="" >
	        </td>
	      </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
  ...
  <script type="text/javascript">
  	 alert("如复制其他页面的文章“请只保留文本”，操作时请谨慎");

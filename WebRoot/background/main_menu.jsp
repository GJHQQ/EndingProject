	  ...
	  <tr>
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	      ...
	      <tr class="bggray">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom tdb"><img src="background/images/main/dirfirst.gif" width="15" height="13"></td>
	      ...
	      <tr>
	        <td align="center" valign="middle" class="borderright borderbottom"><input type="text" name="" class="text-word" value="112"></td>
	        <td align="left" valign="middle" class="borderright borderbottom tdb"><img src="background/images/main/dirsecond.gif" width="29" height="29"></td>

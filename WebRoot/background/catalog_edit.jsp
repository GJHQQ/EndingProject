...
<html>
  ...
  <body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	  <tr>
	    <td width="99%" align="left" valign="top">您的位置：栏目管理&nbsp;&nbsp;>&nbsp;&nbsp;编辑栏目</td>
	  </tr>
	  <tr>
	    <td align="left" valign="top" id="addinfo">
	    <a href="background/main_edit.jsp" target="mainFrame" onFocus="this.blur()" class="add">编辑栏目</a>
	    </td>
	  </tr>
	  <tr>
	    <td align="left" valign="top">
	    <form method="post" action="CatalogServlet?type=catalogupdate">
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <input type="text" name="caname" value="${requestScope.catalog.ca_name}" class="text-word">
	        </td>
	        </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        <td align="right" valign="middle" class="borderright borderbottom bggray">栏目序号：</td>
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input type="text" name="canumber" value="${requestScope.catalog.ca_number }" class="text-word" id="user_pwd" placeholder="" maxlength="8" minlength="4" readonly="readonly">
	        </td>
	        </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <c:if test="${requestScope.catalog.ca_state eq 1}">
	        	<option value="1" selected="selected">&nbsp;&nbsp;启用</option>
	        	<option value="2" >&nbsp;&nbsp;未启用</option>
	        </c:if>
	         <c:if test="${requestScope.catalog.ca_state eq 2}">
	      ...
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input name="caid" type="hidden" value="${requestScope.catalog.ca_id }" class="text-but">
	        <input name="" type="submit" value="提交" class="text-but" onclick="getvalue()">

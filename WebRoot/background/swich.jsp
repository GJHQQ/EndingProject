...
<html>
  ...
  <body marginwidth="0" marginheight="0" onLoad="load()" topmargin="0" leftmargin="0" onselectstart="return false" oncontextmenu=return(false) style="overflow-x:hidden;">
	...
	<td id="leftbar" style="display: none; background:url(background/images/main/switchbg.jpg) repeat-y #d2d2d0 0px 0">
	<a onClick="switchSysBar()" href="javascript:void(0);">
	<img src="background/images/main/pic24.jpg" width="12" height="72" border="0" alt="闅愯棌宸︿晶鑿滃崟" >
	</a>
	</td>
	<td id="rightbar"style="background:url(background/images/main/switchbg.jpg) repeat-y #f2f0f5 0px 0">
	<a onClick="switchSysBar()" href="javascript:void(0);">
	<img src="background/images/main/pic23.jpg" width="12" height="72" border="0" alt="闅愯棌宸︿晶鑿滃崟" >
	</a>
	</td>
	</tr>
	</tbody>

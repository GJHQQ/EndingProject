...
<article>
  <div class="l_box f_l">
    ...
    <div class="box">
		<h1 class="ar_title">${requestScope.article.ar_title }</h2>
		<div class="nat">
	...
	for(var i = 0; i < oLi.length; i++)
	{
      ...
      <div class="ms-main" id="ms-main">
        <div style="display: block;" class="bd bd-news" >
          <ul>
          	<!-- 点击排行 -->
            <c:forEach items="${requestScope.arclicks}" var="arlist">
            	<li><a href="IndexServlet?type=articlecontent&arid=${art.ar_id }" target="_blank">${arlist.ar_title }</a></li>
            </c:forEach>
        ...
        <div  class="bd bd-news">
          <ul>
          <!-- 最新文章 -->
            <c:forEach items="${requestScope.articles}" var="arlist">
            	<li><a href="IndexServlet?type=articlecontent&arid=${art.ar_id }" target="_blank">${arlist.ar_title }</a></li>
            </c:forEach>
          </ul>
        </div>
